...
namespace ApiSite
{
    public class Verificacao
    {
        ...
        public static bool VerificarAtualizacaoUsuario(Usuario usuarioNovosDados, List<string> usuarioAntigosDados)
        {
            return (usuarioNovosDados.idade != 0)
                                     && usuarioNovosDados.idade != int.Parse(usuarioAntigosDados[2])
                                       ...
                                       && Verificacao.ContarDigitosIdadeESenha(usuarioNovosDados.idade) <= 3
                                        && usuarioNovosDados.endereco != null
                                         && usuarioNovosDados.endereco != ""
                                          && usuarioNovosDados.endereco != usuarioAntigosDados[3]
                                           && usuarioNovosDados.senha != 0
                                            && usuarioNovosDados.senha != int.Parse(usuarioAntigosDados[5])
